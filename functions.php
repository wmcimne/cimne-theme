...
function cimne_insertar_js(){
    ...
    wp_register_script('cimne_views_scripts', get_stylesheet_directory_uri(). '/js/views.js', array('jquery'), '1', true );
    wp_enqueue_script('cimne_views_scripts');

    //echo get_permalink();

	if (is_page( 'projects' )) {      
        wp_register_script('cimne_projects_scripts', get_stylesheet_directory_uri(). '/js/projects_scripts.js', array('jquery'), '1', true );
        wp_enqueue_script('cimne_projects_scripts' , get_stylesheet_directory_uri(). '/js/projects_scripts.js', array('jquery'), '1', true );
        wp_localize_script('cimne_projects_scripts','cimne_vars',['ajaxurl'=>admin_url('admin-ajax.php')]);
    }
    if (is_page_child_of( 'research-clusters' )) {  
        ...
        wp_register_script('cimne_cluster_scripts', get_stylesheet_directory_uri(). '/js/cluster_scripts.js', array('jquery'), '1', true );
        wp_enqueue_script('cimne_cluster_scripts', get_stylesheet_directory_uri(). '/js/cluster_scripts.js', array('jquery'), '1', true );
        wp_localize_script('cimne_cluster_scripts','cimne_vars',['ajaxurl'=>admin_url('admin-ajax.php')]);
